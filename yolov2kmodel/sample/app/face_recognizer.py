...
feature_extractor.load_kmodel("/sd/sample/resource/kmodel/feature_extraction.kmodel")
...
while True:
    ...
    for face in faces:
        ...
        if max_score > score_threshold:
            img.draw_rectangle(x, y, w, h, color=(0, 255, 0))
            font.img_draw_string(img, x + 2, y + 2, img.width(), 16, str(scores.index(max(scores))), 16, (0, 255, 0))
